...
Rails.application.config.assets.precompile += %w( memorial.js )
Rails.application.config.assets.precompile += %w( favorite.js )
Rails.application.config.assets.precompile += %w( destroy.js )
Rails.application.config.assets.precompile += %w( memorial.js)
Rails.application.config.assets.precompile += %w( scroll.js )
Rails.application.config.assets.precompile += %w( memorial_post.js )
