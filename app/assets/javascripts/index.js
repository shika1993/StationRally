...
window.onload = function() {
    ...
    for ( var i=0, l=ids.length; l>i; i++ ) {
      ...
      var icon1 = new Y.Icon('https://shikanai1993.s3-ap-northeast-1.amazonaws.com/uploads/image/picture/images_V1/camera.jpg',{className: "icons1 "+ ids[i]+" "+ names[i] + " " +station_points[i]});
